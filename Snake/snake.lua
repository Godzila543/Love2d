function Snake()
	...
	snake.rays={}
	for i=1,14 do
		table.insert(snake.rays,ray(snake.segments[1].pos, math.rad(math.lerp(-120,120,i,14)-90), "wall"))
	end
	for i=1,14 do
		table.insert(snake.rays,ray(snake.segments[1].pos, math.rad(math.lerp(-120,120,i,14)-90), "food"))
	end
	for i=1,14 do
		table.insert(snake.rays,ray(snake.segments[1].pos, math.rad(math.lerp(-120,120,i,14)-90), "snake"))
	end
	...
	function snake.turn(phi)
		snake.heading:rotateInplace(phi)
	end
